...
<div class="block relative" v-if="viewType === 'primary'">
  ...
  <div class="block" v-if="viewType === 'secondary'">
    <div class="w-full py-4 border-b-2 border-gray-200">
      <div class="overflow-hidden h-10 w-10 inline-block mr-2">
        <img :src="politician.profileImage" class="w-full h-full"/>
      </div>
      <div class="inline-block text-block align-middle">
