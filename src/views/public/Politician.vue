...
export default {
  ...
  methods: {
    ...
    getShareText(name, position) {
      return `I’m monitoring the progress and performance of${position.name ? ` ${position.name}` : ''} ${name} and other African leaders on Ourleaders.Africa.`;
    },
    handleScroll() {
