  ...
  <div class="relative">
    ...
    <div class="flex flex-wrap pb-2" v-if="!loading">
      <div class="w-full lg:w-1/3 md:py-8 py-2 px-2 lg:px-16 md:border-r-2 border-gray-200 overflow-y-scroll">
        ...
        <div class="flex lg:hidden w-full justify-between px-3">
          <div id="votes" class="inline-block pr-5">
            <img class="inline-block mr-2 md:mr-2 h-4 md:h-4" src="@/assets/img/thumbs-up.svg"/>
            <span class="inline-block mr-3 md:mr-4 h-4 md:h-4 align-middle text-xs md:text-sm">{{politicalParty.vote ? politicalParty.vote.up : '0'}}</span>
            <img class="inline-block mr-2 mt-2 md:mr-2 h-4 md:h-4" src="@/assets/img/thumbs-down.svg"/>
            <span class="inline-block mr-2 md:mr-2 h-4 md:h-4 align-middle text-xs md:text-sm">{{politicalParty.vote ? politicalParty.vote.down : '0'}}</span>
          </div>
        ...
        <div class="hidden lg:flex flex-wrap" v-if="politicalParty.socials.twitter">
      ...
      <div class="w-full lg:w-2/3 pl-2 md:px-10 py-1 md:py-4 md:max-h-screen overflow-y-scroll relative" sticky-container>
        ...
        <div v-sticky sticky-offset="offset" sticky-side="top" ref="stickyTop">
          <div class="w-full lg:w-9/12 overflow-x-scroll mt-6 md:pr-4">
        ...
        <div class="flex flex-col-reverse lg:flex-row xl:flex-row">
          <div class="w-full lg:w-9/12 xl:w-9/12 align-top block lg:inline-block xl:inline-block relative">
            <transition-group name="fade" mode="out-in">
              <div class="relative top-0 left-0 w-full mb-4 border-b-2 lg:border-b-0 border-gray-200" key="background" v-if="isPage('background')">
                <div class="flex">
              ...
              <div class="relative top-0 left-0 w-full mb-10" key="offices" v-if="isPage('offices')">
                <our-offices :data="politicians"></our-offices>
              </div>
              <div class="relative top-0 left-0 w-full mb-10" key="ideology" v-if="isPage('ideology')">
            ...
            <div class="block lg:hidden w-full mb-4 pt-10" v-if="politicalParty.socials.twitter">
              <div class="w-full border-b-1 border-gray-400">
                <!-- <span class="text-2xl mr-2">Tweets</span>
                <span class="text-base mr-1">by</span>
                <span class="cursor-pointer twitter-link text-base">@MBuhari</span>
